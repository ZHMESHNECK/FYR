...
- Python 3.9 и выше
- PostgreSQL
- firefox ( для парсинга olx ), а также geckodriver v0.33.0
...
```
6. Возможно у вас появится ошибка при парсинге olx, для этого заходим в utils/olx_par.py на 20 строчку и указываем свой путь к firefox
